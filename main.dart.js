...
return z},"fX","$get$fX",function(){return[".material-header._ngcontent-%ID%{background-color:transparent}.material-header-title._ngcontent-%ID%{color:black}#menu-icon._ngcontent-%ID%{color:black}#full-page-splash._ngcontent-%ID%{height:93vh}"]},"fM","$get$fM",function(){return[$.$get$fW(),$.$get$fX()]}])
